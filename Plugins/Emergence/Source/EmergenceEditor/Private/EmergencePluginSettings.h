...
public:
	...
	//The IPFS node to use when getting IPFS data via HTTP. Leaving it blank will use the default "https://ipfs.io/ipfs/". The IPFS hash will be added to the end (for example, using the default: "https://ipfs.io/ipfs/Qme7ss3ARVgxv6rXqVPiikMJ8u2NLgmgszg13pYrDKEoiu")
