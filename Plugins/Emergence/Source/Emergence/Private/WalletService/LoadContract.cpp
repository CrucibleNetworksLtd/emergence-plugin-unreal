...
void ULoadContract::Activate()
{
	...
	UE_LOG(LogTemp, Display, TEXT("LoadContract request started with JSON, calling LoadContract_HttpRequestComplete on request completed. Json sent as part of the request: "));
